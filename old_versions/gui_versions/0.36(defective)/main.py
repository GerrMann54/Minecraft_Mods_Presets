...
1.0 Выведение списков реализовано через def
1.0 Добавлен графический интерфейс.
'''
...
class App(QtWidgets.QMainWindow, mmp_en.Ui_MainWindow):
    ...
    def get_presetsList(self):
        ...
        presetsList = mf.get_presetsList()
    ...
    def get_modList(self):
        ...
        current_modList = mf.get_modList()
